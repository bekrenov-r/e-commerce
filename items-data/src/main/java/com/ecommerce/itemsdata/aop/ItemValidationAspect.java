...
public class ItemValidationAspect {
    ...
    @Pointcut("execution(* com.ecommerce.itemsdata.controller.ItemController.*(java.lang.Integer))")
    public void hasIntegerParam(){}

    @Pointcut("execution(* com.ecommerce.itemsdata.controller.ItemController.*(java.util.List))")
